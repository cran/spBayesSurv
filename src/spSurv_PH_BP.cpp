...
RcppExport SEXP PH_BP(SEXP nburn_, SEXP nsave_, SEXP nskip_, SEXP ndisplay_, SEXP ltr_,
...
RcppExport SEXP PH_BP_plots(SEXP tgrid_, SEXP xpred_, SEXP theta_, SEXP beta_, SEXP weight_, 
                            SEXP CI_, SEXP dist_){
  BEGIN_RCPP
  // Transfer R variables into C++;
